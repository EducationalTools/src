...
<div class="flex h-screen flex-col items-center justify-center">
	...
	{:else if !isAuthenticated}
		<!-- Sign In Component -->
		<div class="flex w-full max-w-md flex-col gap-4 rounded-lg p-6 shadow-md">
	...
	{:else if isAuthenticated}
		<!-- Dashboard Component -->
		<div class="w-full max-w-md rounded-lg p-6 text-center shadow-md">
			...
			<div class="mb-4 rounded-md p-4">
				...
				{#if accessToken}
					<div class="mt-2 rounded border p-2 text-xs break-all text-gray-600">
